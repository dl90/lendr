...
const BottomNav = ({ exploreActive, lendActive, postActive, chatActive, settingsActive }) => {
    const [toggleExplore, setToggle] = useState(false);
    ...
    return <NavBar>
        <Explore onClick={() => {
            ...
            <div>
                {/* <img alt="Explore" src="./exploreIcon.svg" /> */}
        ...
        <More onClick={() => {
            ...
            {/* <img alt="settings" src="./settingsIcon.svg" /> */}
