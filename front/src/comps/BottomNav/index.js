      ...
      <NavBar>
          ...
          >
            <div>
              <svg id='exploreIcon' width='23' height='23' viewBox='0 0 23 23' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <path fillRule='evenodd' clipRule='evenodd' d='M1 3.6C1 2.16406 2.16406 1 3.6 1H18.6766C20.1126 1 21.2766 2.16406 21.2766 3.6V18.6766C21.2766 20.1125 20.1126 21.2766 18.6766 21.2766H3.6C2.16406 21.2766 1 20.1125 1 18.6766V3.6Z' stroke={exploreActiveValue === 1 ? 'orange' : 'black'} strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
                <path d='M1 7.75885H21.2766' stroke={exploreActiveValue === 1 ? 'orange' : 'black'} strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
                <path d='M7.75879 21.2766V7.75885' stroke={exploreActiveValue === 1 ? 'orange' : 'black'} strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
              </svg>
            </div>
            <div>Home</div>
          </Explore>
        ...
        <Link to='/lendingAvailable'>
          <Lend
            ...
            lendActive={exploreActiveValue === 2 ? '#FF8A00' : '#201823'}
          >
            <svg id='lendIcon' width='28' height='24' viewBox='0 0 28 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
              <path d='M19.4655 22V19.7795C19.4655 17.3269 17.432 15.3386 14.9236 15.3386H5.83975C3.33133 15.3386 1.29785 17.3269 1.29785 19.7795V22' stroke={exploreActiveValue === 2 ? 'orange' : 'black'} strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round' />
              <path fillRule='evenodd' clipRule='evenodd' d='M10.3817 10.8976C12.8902 10.8976 14.9237 8.90928 14.9237 6.4566C14.9237 4.00392 12.8902 2.01562 10.3817 2.01562C7.87332 2.01562 5.83984 4.00392 5.83984 6.4566C5.83984 8.90928 7.87332 10.8976 10.3817 10.8976Z' stroke={exploreActiveValue === 2 ? 'orange' : 'black'} strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round' />
              <path d='M26.2782 22V19.7795C26.2767 17.7557 24.8759 15.9889 22.8718 15.4829' stroke={exploreActiveValue === 2 ? 'orange' : 'black'} strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round' />
              <path d='M18.3301 2.15997C20.3398 2.6631 21.7454 4.43374 21.7454 6.46216C21.7454 8.49059 20.3398 10.2612 18.3301 10.7644' stroke={exploreActiveValue === 2 ? 'orange' : 'black'} strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round' />
            </svg>
            <div>Lend</div>
          </Lend>
        </Link>
        ...
        <Link to='/messages'>
          <ChatDiv
            ...
            chatActive={exploreActiveValue === 4 ? '#FF8A00' : '#201823'}
          >
            <svg id='chatIcon' width='28' height='23' viewBox='0 0 28 23' fill='none' xmlns='http://www.w3.org/2000/svg'>
              <path d='M26.2354 12.6975H18.6647L16.1412 16.5133H11.0941L8.57061 12.6975H1' stroke={exploreActiveValue === 4 ? 'orange' : 'black'} strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
              <path fillRule='evenodd' clipRule='evenodd' d='M5.37833 2.76361L1 12.6975V19.0572C1 20.4622 2.12983 21.6011 3.52354 21.6011H23.7118C25.1055 21.6011 26.2354 20.4622 26.2354 19.0572V12.6975L21.857 2.76361C21.4524 1.84281 20.547 1.24931 19.548 1.25H7.68737C6.68833 1.24931 5.78294 1.84281 5.37833 2.76361Z' stroke={exploreActiveValue === 4 ? 'orange' : 'black'} strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            </svg>
            <div>Chat</div>
          </ChatDiv>
        </Link>
